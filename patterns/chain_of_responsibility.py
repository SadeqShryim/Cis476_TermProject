...
Three security questions handling mechanisms are linked in chain form. Every mechanism validates
the answer to one security question. In case all three validate,
the user is permitted to reset their password.
"""
